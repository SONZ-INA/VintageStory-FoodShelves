...
public static class ShapeReferences {
    ...
    public const string utilJar = "foodshelves:shapes/util/jarcontentcube.json";
    public const string utilJarLarge = "foodshelves:shapes/util/jarlargecontentcube.json";
